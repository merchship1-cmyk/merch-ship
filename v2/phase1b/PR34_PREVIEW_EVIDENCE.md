...
- Final merged-main commit: `5a99d90050b25e10bdd7230c2a4ffd85ca182d21`
- Final merged-main tree: `0f9c61fdbfc3132723d80c58a732d5dc5678c338`

The tested merge candidate and the final GitHub merge commit have the identical tree SHA. Therefore the retained APK was built from source content identical to the source content integrated into `main`; only the merge commit identity/timestamp differs.
...
This is supplemental evidence tied to the exact tested/final tree SHA; it does not modify the immutable retained build artifact.
